      ...
      <div className="max-w-7xl mx-auto">
          ...
          {goals.map((goal) => (
            <div key={goal.id} className="bg-gray-800  p-6 rounded-xl border border-gray-700">
              <div className="flex justify-between items-start mb-4">
                <h3 className="text-xl font-semibold text-gray-100">{goal.name}</h3>
        ...
        {goals.length === 0 && (
          <div className="text-center py-20">
            <h3 className="text-2xl font-semibold text-gray-200 mb-4">No goals yet</h3>
            <p className="text-gray-300 mb-6">Start by creating your first savings goal</p>
